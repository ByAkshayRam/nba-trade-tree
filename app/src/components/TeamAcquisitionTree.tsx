...
const ESPN_PLAYER_IDS: Record<string, string> = {
  ...
  "Jalen Johnson": "4432166",
  "Clint Capela": "3102530",
  "Bogdan Bogdanovic": "3102531",
  "Onyeka Okongwu": "4432158",
  "Garrison Mathews": "4066259",
  "Kobe Bufkin": "4683027",
  "Zaccharie Risacher": "5185581",
  "David Roddy": "4433163",
  "Vit Krejci": "4433942",
  // Brooklyn Nets
  "Cam Thomas": "4432577",
  ...
  // Atlanta Hawks (new core)
  "CJ McCollum": "2490149",
  "Jonathan Kuminga": "4433247",
  "Buddy Hield": "2990992",
  "Dyson Daniels": "4683786",
  "Corey Kispert": "4397189",
  "Nickeil Alexander-Walker": "4395724",
  "Gabe Vincent": "4066389",
  "Jock Landale": "4065804",
  "Christian Koloko": "4432897",
  "Caleb Houstan": "4683788",
  "Mouhamed Gueye": "4702015",
  "Nikola Durisic": "5175648",
  "Asa Newell": "5238231",
  // Brooklyn Nets
  ...
  const getTeamData = useCallback(() => {
    ...
    const franchisePlayers = sortedRoster
      ...
      .map(n => {
        ...
        const espnId = ESPN_PLAYER_IDS[label];
        return {
          name: label,
          espnId,
          headshotUrl: espnId 
